 ...
 */
	Configure::write('Routing.prefixes', array('rest', 'ajax', 'user', 'admin'));
 ...
 */
	Configure::write('Security.salt', '5O379oAbQOgxnbccDmGCA7P9ueJXyB8tg1rfgRhX');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '63544082863761631814553499337');
